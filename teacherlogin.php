...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($_POST["email"])) {
        $StudentIdError = "Email id  is required";
    } 
...
<?php
  ...
  $result = $obj1->connreturn();
    ...
    $sql = "select * from registration where email= '".$email1."'
       and password = '".$password1."' and role = 'teacher' ";
...
<div class="container">
    <h2 class="text-black bg-light text-center"><b> Teacher Login here</b></h2>
    <div>
        <form method="post">
